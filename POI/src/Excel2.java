...
public class Excel2
{
  ...
  {
	  FileInputStream fis=new FileInputStream("D:\\Harish\\POI\\exceldata\\demo.xlsx");
...
//      driver.get("http://webmail.cubicitsolution.co.in/logout/?locale=en");
      FileOutputStream fos=new FileOutputStream("D:\\Harish\\POI\\exceldata\\demo.xlsx");
     
	  sh.getRow(0).createCell(0).setCellValue("User ID");
	  sh.getRow(0).createCell(1).setCellValue("password");
	  sh.getRow(1).createCell(0).setCellValue("harish.r@cubicitsolution.com");
